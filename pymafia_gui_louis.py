...
class FenetrePymafia(Tk):
    def __init__(self):
        ...
        self.framesJoueurs[0].grid(row=0, column=0, padx=15, pady=15)
        self.framesJoueurs[1].grid(row=0, column=2, padx=15, pady=15)
        self.framesJoueurs[2].grid(row=2, column=2, padx=15, pady=15)
        self.framesJoueurs[3].grid(row=2, column=0, padx=15, pady=15)
